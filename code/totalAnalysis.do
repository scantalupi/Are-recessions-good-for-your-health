...
*** and genetate the tables with the fixed effect estimates 
*************************************
*************************************
clear all 
set more off
...
use "$datapath/clean/totalFinal.dta", clear

br

*** Descriptive statistic
eststo drop *
estpost summarize activity_rate unemployment_rate gdp_change ///          
     death_rate malignant_tumors_rate ischameic_hearth_rate cerebrovascular_rate ///
...
eststo drop *
eststo: xtreg death_rate gdp_change year, vce(cluster cross) fe

eststo: xtreg malignant_tumors_rate gdp_change year, vce(cluster cross) fe

eststo: xtreg ischameic_hearth_rate gdp_change year, vce(cluster cross) fe

eststo: xtreg cerebrovascular_rate gdp_change year, vce(cluster cross) fe

eststo: xtreg other_hearth_rate gdp_change year, vce(cluster cross) fe

eststo: xtreg digestive_system_rate gdp_change year, vce(cluster cross) fe

eststo: xtreg transportation_accidents_rate gdp_change year, vce(cluster cross) fe

eststo: xtreg sucidie_rate gdp_change year, vce(cluster cross) fe

eststo: xtreg nonmalignant_tumors_rate gdp_change year, vce(cluster cross) fe

eststo: xtreg h_c_amenable_rate gdp_change year, vce(cluster cross) fe
